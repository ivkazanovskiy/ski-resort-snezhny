    ...
    <div className="w-full">
      ...
      <Listbox defaultValue={selectedTrainer} onChange={setSelectedTrainer}>
        <div className="relative">
          <Listbox.Button className="relative p-2 rounded-lg w-full text-left backdrop-blur-sm bg-white/30">
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <Listbox.Options className="absolute bottom-10 backdrop-blur-sm bg-white/30 w-full py-1 mt-1 overflow-auto rounded-lg max-h-60">
              {
